...
const WomenJeans = () => {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      material: "Wool Blend",
      images: [
        "/lovable-uploads/0add1fce-a6b1-41c0-952d-11a28bd00c28.png",
        "/lovable-uploads/5f3b1091-fe3e-45af-9d34-4d0faecf3f7a.png"
      ]
    },
    {
      id: 3,
      ...
      isNew: true,
      images: [
        "/lovable-uploads/50904a57-14e1-47dd-ab0d-b7ef713b6961.png",
        "/lovable-uploads/e0353c5a-4cc1-4bd5-aca3-e0995c500a36.png"
      ]
    },
    {
      id: 4,
      ...
      material: "100% Cotton",
      images: [
        "/lovable-uploads/c8cbb710-3ec4-4915-8f1f-57773fcad387.png",
        "/lovable-uploads/1072cfc7-8d68-43ca-bec0-3411744d2ccd.png"
      ]
    }
  ];
      ...
      <main className="container mx-auto px-6 pt-32 pb-20">
        ...
        <nav className="mb-8">
          <ol className="flex text-sm text-[#595959]">
            ...
            <li className="text-[#a67c52]">Jeans & Trousers</li>
          </ol>
        </nav>
        ...
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center">
            ...
            <h1 className="text-3xl font-serif font-light">Jeans & Trousers</h1>
          </div>
